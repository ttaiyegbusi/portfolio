...
/* ------------------------------------------------------------------ */
/* Frame positions in virtual-canvas coordinates.                      */
/* The left sidebar pans to these when a page is selected.              */
/* ------------------------------------------------------------------ */
...
const HERO_X = VIRTUAL_CANVAS.w / 2 - 318; // left edge of the 636px-wide hero column
const HERO_Y = VIRTUAL_CANVAS.h / 2 - 330;

/* Live Lagos time, like the "6:45pm - Lagos, Nigeria" row in the screenshot */
...
/* The ultra-light pictogram wall across the top of the profile card */
...
/* Decorative portfolio frame scattered around the canvas */
  ...
  return (
    <>
      ...
      <section className="absolute" style={{ left: HERO_X, top: HERO_Y, width: 636 }}>
        {/* Card group: profile card + social tile cluster */}
